...
public class ArrayGenerator {
    ...
    public static class Alphbets {
         ...
         * 打印一个String 数组
         *
         * @param s 要打印的String数组
         */
        public static void print(String[] s) {
            for (int i = 0; i < s.length; i++)
                StdOut.printf("%3d", i);
            StdOut.println();
            for (String value : s) StdOut.printf("%3s", value);
            StdOut.println("\n");
        }
    }
     ...
     *
     * @param N             数组尺寸
     * @param probabilities 概率集，加起来必须等于1
     * @return 按照指定概率离散分布的 N 个值
     */
    @SuppressWarnings("unused")
     ...
     * @return 转换好的数组
     */
    @SuppressWarnings({"WeakerAccess", "SpellCheckingInspection", "UnnecessaryUnboxing"})
     ...
     * @return 转换好的数组
     */
    @SuppressWarnings({"SpellCheckingInspection", "unused", "UnnecessaryUnboxing"})
     ...
     * @return 转换好的数组
     */
    @SuppressWarnings({"unused", "SpellCheckingInspection", "UnnecessaryUnboxing"})
     ...
     * @return 转换好的数组
     */
    @SuppressWarnings({"unused", "SpellCheckingInspection", "ConstantConditions", "UnnecessaryUnboxing", "RedundantCast"})
     ...
     */
    @SuppressWarnings({"WeakerAccess", "DuplicatedCode", "UnnecessaryBoxing"})
    public static Integer[] Integers(int size, int lo, int hi) {
        ...
        for (int i = 0; i < size; i++)
            arr[i] = Integer.valueOf(StdRandom.uniform(lo, hi + 1));
        return arr;
    }
     ...
     */
    @SuppressWarnings({"SpellCheckingInspection", "DuplicatedCode", "WeakerAccess"})
     ...
     */
    @SuppressWarnings({"WeakerAccess", "UnnecessaryBoxing", "DuplicatedCode"})
     ...
     */
    @SuppressWarnings({"WeakerAccess", "SpellCheckingInspection", "DuplicatedCode"})
     ...
     */
    @SuppressWarnings({"DuplicatedCode", "SpellCheckingInspection", "WeakerAccess"})
    ...
    public static void print(Comparable[] a) {
        ...
        for (int i = 0; i < a.length; i++)
            StdOut.printf("%-7d", i);
        StdOut.println();
        for (Comparable comparable : a) StdOut.printf("%-7s", comparable.toString());
        StdOut.println();
    }
    ...
    public static void print(Double[] a) {
        ...
        for (int i = 0; i < a.length; i++)
            StdOut.printf("%-7d", i);
        StdOut.println();
        for (Double aDouble : a) StdOut.printf("%-7.2f", aDouble.doubleValue());
        StdOut.println();
    }
    ...
    public static void print(double[] a) {
        ...
        for (int i = 0; i < a.length; i++)
            StdOut.printf("%-5d", i);
        StdOut.println();
        for (double v : a) StdOut.printf("%-5.1f", v);
        StdOut.println();
    }
    ...
    public static void print(int[] a) {
        ...
        for (int i = 0; i < a.length; i++)
            StdOut.printf("%-4d", i);
        StdOut.println();
        for (int value : a) StdOut.printf("%-4d", value);
        StdOut.println();
    }
    ...
    public static void print(char[] a) {
        ...
        for (int i = 0; i < a.length; i++)
            StdOut.printf("%-4d", i);
        StdOut.println();
        for (char c : a) StdOut.printf("%-4c", c);
        StdOut.println();
    }
